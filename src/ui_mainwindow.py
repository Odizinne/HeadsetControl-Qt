...
class Ui_HeadsetControlQt(object):
    def setupUi(self, HeadsetControlQt):
        ...
        HeadsetControlQt.resize(487, 376)
        ...
        self.gridLayout_5.addWidget(self.ledLabel, 1, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.lightBatterySpinbox, 2, 2, 1, 1)
        self.notification_label = QtWidgets.QLabel(parent=self.frame)
        self.notification_label.setMinimumSize(QtCore.QSize(0, 25))
        self.notification_label.setObjectName("notification_label")
        self.gridLayout_5.addWidget(self.notification_label, 3, 0, 1, 1)
        self.notificationBatterySpinbox = QtWidgets.QSpinBox(parent=self.frame)
        self.notificationBatterySpinbox.setMinimumSize(QtCore.QSize(100, 25))
        self.notificationBatterySpinbox.setFrame(False)
        ...
        self.gridLayout_5.addWidget(self.notificationBatterySpinbox, 3, 2, 1, 1)
